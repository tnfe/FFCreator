...
const { createCanvas, createImageData, WebGLRenderer, Texture, Sprite, gl } = require('../../inkpaint/lib/index');
...
class FFTransition extends FFClip {
  ...
  getSnapshotBuffer(display) {
    ...
    this.renderer.view.rgbReverse = true; // 否则颜色是BGR，很奇怪
    return this.renderer.view.toBuffer('raw');
  }
