...
class FFCon extends FFBase {
  ...
  /**
   * Add child elements
   * @param { import("../node/node") } child - node object
   * @public
   */
  addChild(child) {
   ...
   * @param { import("../node/node")[] } children - any node object
   * @public
   */
   ...
   * @param { import("../node/node") } scene - node object
   * @public
   */
