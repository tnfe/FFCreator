...
jest.mock('@tweenjs/tween.js', ()=> ({
  Tween: jest.fn(function() {
    this.to = jest.fn(function() {return this})
    this.delay = jest.fn(function() {return this})
    this.easing = jest.fn(function() {return this})
    this.onUpdate = jest.fn(function() {return this})
    this.start = jest.fn(function() {return this})
  })
}))
